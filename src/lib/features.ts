...
export const FEATURES: Feature[] = [
  {
    ...
    icon: Brain,
    image: IMAGES.featureGuidedBuilder,
    bullets: [
  ...
  },
  {
    ...
    icon: CheckCircle2,
    image: IMAGES.featureLivePreview,
    bullets: [
  ...
  },
  {
    ...
    icon: TrendingUp,
    image: IMAGES.featureManageResumes,
    bullets: [
